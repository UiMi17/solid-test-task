...
const Header = () => {
    ...
    return <header className='flex justify-between items-center w-full max-w-[420px] px-4 pt-5 desktop:justify-end desktop:pt-4 desktop:px-0 desktop:max-w-[872px]'>
        {!isDesktop && <>
            <BackBtn/>
